...
function JobposterNotification({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      ...
      <Text>we are working on NOTIFICATION feature.....</Text>
          ...
          <View style={{ marginHorizontal: 15 }}>
            ...
            >
              <View style={{ marginLeft: 5 }}>
                ...
                >
                  A Candidate has recently shown interest in your profile
                </Text>
              </View>
            </View>
            {/* 2 */}
...
export default JobposterNotification;
